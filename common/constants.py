...
# general constants
PYRUSTIC_DATA = "PyrusticDataDev" if about.DEV_MODE else "PyrusticData"
...
DEFAULT_SUITE_SHARED_DATA_FILE = os.path.join(about.ROOT_DIR,
                                              "common",
                                              "default_json_data",
...
DEFAULT_MANAGER_SHARED_DATA_FILE = os.path.join(about.ROOT_DIR,
                                                "common",
                                                "default_json_data",
...
DEFAULT_SQLEDITOR_SHARED_DATA_FILE = os.path.join(about.ROOT_DIR,
                                                  "common",
                                                  "default_json_data",
...
DEFAULT_RUNTEST_SHARED_DATA_FILE = os.path.join(about.ROOT_DIR,
                                                "common",
                                                "default_json_data",
...
DEFAULT_HUB_SHARED_DATA_FILE = os.path.join(about.ROOT_DIR,
                                              "common",
                                              "default_json_data",
