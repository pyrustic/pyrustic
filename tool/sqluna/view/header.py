...
class Header(Viewable):
    ...
    def _on_build(self):
        ...
        self._body.columnconfigure(1, weight=2)
        self._body.columnconfigure(3, weight=3)
    ...
    def _on_display(self):
        description, data = self._internal_data_manager.previously_stored(self._project)
        if data:
            self._open(data[0][2])
